...
do
  ...
  autoscaler -usertoken=$USER_TOKEN -accesstoken $ACCESS_TOKEN -apiurl $URL -frequency 20 -nodetype r3.4xlarge -nodetyperam 122792 -tts 60 -policy=general -nodestorage ephemeral 2>&1 | tee  autoscaler.log
done
